...
剛剛組長有跟我說一個東西是wazuh，據說是跟 MCP 相關的東西，他是希望這個東西可以串接上 dashboard，讓他可以自動化呈現我們想要的資訊，感覺有機會可以玩玩看。我應該今天還是會希望可以至少把 ELK 那邊弄好，之後再看看 wazuh 是怎麼使用的，看能不能連 ELK 進行使用。ELK 安裝沒有我想像中的容易，感覺是我還ㄊ
## 學到的東西
